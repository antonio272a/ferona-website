...
const loadWebsite = async (solutionName, solutionId) => {
  
  const baseOptions6 = {
    distID: "latest",
    solution3DName: solutionName,
    projectName: "first-project",
    solution3DID: solutionId,
    containerID: "container3d_replace",
  };
  ...
  const topMaterialContainer = document.getElementById(
    "top-material-container"
  );
  const bottomMaterialContainer = document.getElementById(
    "bottom-material-container"
  );
...
window.onload = () => {
  ...
  testButton.addEventListener('click', () => {
    ...
    const { value: idValue } = idInput;
    loadWebsite(nameValue.trim(), idValue.trim());
